...
class Swift_Controller_Action extends Zend_Controller_Action
{
	 ...
	 public function initView()
    {
        ...
        $success = $this->getRequest()->getParam('success',false);
        if($success){
        ...
        $this->view->level_commissions = (array) $settingsModel->getLevelCommissions();
        
        
        $this->view->stateArray = array('AL'=>"Alabama",  
			'AK'=>"Alaska",  
			'AZ'=>"Arizona",  
			'AR'=>"Arkansas",  
			'CA'=>"California",  
